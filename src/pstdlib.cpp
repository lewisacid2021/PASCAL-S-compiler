...
// void PLib::Preserve(SymbolTable* st) {
...
// bool PLib::Call(std::string lib_name) {
...
// bool PLib::UnCall(std::string lib_name) {
//   if (lib_map_.find(lib_name) != lib_map_.end()) {
...
// void PLib::Generationvisitor(FILE* dst) {
//   // format cstdlib
